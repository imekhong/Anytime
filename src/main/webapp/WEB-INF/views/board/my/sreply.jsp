...
<h1 style="color:skyblue;">학교게시판 내 댓글</h1><br>
	<div class="w3-bar">
		<button type="button" class="w3-bar-item w3-button w3-border" onclick="location.href='${contextPath }/my/creply'">
			<i class="fa fa-bars"></i> 자유게시판 댓글 목록
		</button>
		<button type="button" class="w3-bar-item w3-button w3-border w3-blue" onclick="location.href='${contextPath }/my/sreply'">
		...
		<c:if test="${replyList.size() != 0 }">
			<c:forEach var="list" items="${replyList }">
				<div class="w3-container w3-border w3-hover-border-red" style="margin: 0px">
					...
					<a href="${contextPath }/my/sreply/${list.postNo}" style="text-decoration: none;">${list.replyContent }</a>
					</span><br>
