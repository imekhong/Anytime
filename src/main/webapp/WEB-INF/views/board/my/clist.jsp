...
<h1 style="color:skyblue;">자유게시판 내 게시글</h1><br>
	<div class="w3-bar">
		<button type="button" class="w3-bar-item w3-button w3-border w3-blue" onclick="location.href='${contextPath }/my/cboard?page=1'">
			<i class="fa fa-bars"></i> 자유게시판 글 목록
		</button>
		<button type="button" class="w3-bar-item w3-button w3-border" onclick="location.href='${contextPath }/my/sboard?page=1'">
	...
	<div>
		...
		<div style="display: flex; justify-content:center;">
			<ul class="pagination">
				<c:if test="${page != 1 }">
					<li class="page-item"><a class="page-link" href="${contextPath }/my/cboard?page=${page-1 }">Previous</a></li>
				</c:if>
				<c:forEach var="num" begin="1" end="${pageCount }" step="1">
					...
					<c:if test="${num != page }">
						<li class="page-item"><a class="page-link" href="${contextPath }/my/cboard?page=${num }">${num }</a></li>
					</c:if>
				</c:forEach>
				<c:if test="${page != pageCount }">
					<li class="page-item"><a class="page-link" href="${contextPath }/my/cboard?page=${page+1 }">Next</a></li>
				</c:if>
			</ul>
		</div>
	</div>
