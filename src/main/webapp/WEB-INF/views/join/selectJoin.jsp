...
<div class="contentBox">
	...
	<a href="http://localhost:8000/root/auth/naver/join"><img height="50" src="${pageContext.request.contextPath }/resources/img/naverjoin.png"></a>
	<br><br>
	...
	<br>
	<a href="${pageContext.request.contextPath }">로그인 페이지로</a>
	</div>
</div>
</body>
</html>